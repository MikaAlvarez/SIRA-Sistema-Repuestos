        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-2xl rounded-lg px-16 py-12 border-t-4 border-red-600">
                ...
                <div class="text-center mb-8 pb-6 border-b-2 border-gray-100">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Información del Usuario</h3>
                    <p class="text-sm text-gray-600">Complete los datos para crear un nuevo usuario</p>
                </div>
                ...
                <form action="{{ route('usuarios.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="email" 
                               ...
                               value="{{ old('email') }}" 
                               class="block w-full px-5 py-4 rounded-2xl border-2 border-gray-300 text-gray-900 placeholder-gray-400 focus:border-red-600 focus:ring-4 focus:ring-red-100 transition-all duration-200" 
                               placeholder="usuario@sira.com"
                               required>
                        <p class="text-xs text-gray-500 mt-2">💡 Todos los usuarios deberán ser registrados @sira.com</p>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="role" 
                            ...
                            <option value="empleado" {{ old('role') == 'empleado' ? 'selected' : '' }}>👤 Empleado (Solo lectura)</option>
                    ...
                    <div>
                        ...
                        <input type="password" 
                               ...
                               required>
                        <p class="text-xs text-gray-500 mt-2">🔒 Mínimo 8 caracteres</p>
                    </div>
